...
export declare type RemoveCustomMapStyleUpdaterAction = {
    payload: {
        id: string;
    };
};
...
declare type OnLoadMapStyleSuccessCallback = (payload: {
    styleType: string;
}) => any;
/** REQUEST_MAP_STYLES */
...
export declare type SetBackgroundColorUpdaterAction = {
    payload: RGBColor;
};
/**

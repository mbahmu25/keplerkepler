...
export declare type GridLayerVisConfigSettings = {
...
export declare type GridLayerVisConfig = {
    opacity: number;
...
export declare type GridLayerConfig = Merge<AggregationLayerConfig, {
...
export default class GridLayer extends AggregationLayer {
    ...
    renderLayer(opts: any): (EnhancedGridLayer | GeoJsonLayer<unknown, {
        visible: any;
        wrapLongitude: false;
        data: ({
            geometry: {

...
export declare type ActionHandler<A extends Handler> = (...args: Parameters<A>) => void;
export declare type ActionHandlers<T extends {
    [k: string]: Handler;
}> = {
...
export declare type ReceiveMapConfigPayload = {
    config: ParsedConfig;
...
export declare type KeplerGlInitPayload = {
...
export declare type ReplaceDataToMapOptions = {
    centerMap?: boolean;
    keepExistingConfig?: boolean;
    autoCreateLayers?: boolean;
};
export declare type ReplaceDataInMapPayload = {

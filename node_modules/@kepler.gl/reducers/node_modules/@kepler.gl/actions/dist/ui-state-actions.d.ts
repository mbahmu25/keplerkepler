...
export declare type ToggleSidePanelCloseButtonUpdaterAction = {
    payload: {
        show: boolean;
    };
};
...
export declare type setMapControlSettingsUpdaterAction = {
    payload: {
        panelId: string;
...
export declare type TogglePanelListViewAction = {
    payload: {
        panelId: string;
        listView: string;
    };
